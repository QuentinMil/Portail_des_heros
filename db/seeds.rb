...
def generate_backstory(name, race, univers_class, universe, templates)
...
User.all.each do |user|
  3.times do |i|
    ...
    backstory = generate_backstory(name, race.name, univers_class.name, universe.name, backstory_templates)
